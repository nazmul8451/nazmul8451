...
<h1 style="font-size: 46px; color: #00bcd4; margin-bottom: 6px;">🧑‍💻 Rimon Islam</h1>
<h3 style="font-size: 22px; color: #555;">Flutter Developer | Mobile App Engineer | Problem Solver</h3>

<p style="font-size: 16px; color: #777; max-width: 700px; margin: 16px auto;">
...
### 💡 About Me
<div align="center" style="background: linear-gradient(135deg, #e3f2fd, #f3e5f5); border-radius: 16px; padding: 20px; max-width: 750px; margin: 0 auto; box-shadow: 0px 0px 10px rgba(0,0,0,0.1);">
